...
test('Test 2 ', async ({ page }) => {
    ...
    await page.getByPlaceholder('Password').fill('ersrer');
    await page.locator('[name="login"]').click();
    await expect(page.locator('#email_container')).toContainText('Thee email address or mobile number you entered isn\'t connected to an account. Find your account and log in.');
