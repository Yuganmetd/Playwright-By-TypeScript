...
test('Soft Assertions test in Playwright',async({page})=>{
  ...
  await expect.soft(page.getByText('Playwright Beginner Tutorials')).toHaveText('Playwright Beginner Tutorials')
